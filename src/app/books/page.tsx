    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white px-6 py-12">
            <div className="max-w-5xl mx-auto text-center">
                <h1 className="text-4xl font-serif text-amber-900 mb-6">Philosophy Books</h1>
                <form onSubmit={handleSubmit} className="flex justify-center mb-8">
                    <input
                        ...
                        className="w-full max-w-md border border-amber-300 rounded-l-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-400"
                    />
                    <button
                        type="submit"
